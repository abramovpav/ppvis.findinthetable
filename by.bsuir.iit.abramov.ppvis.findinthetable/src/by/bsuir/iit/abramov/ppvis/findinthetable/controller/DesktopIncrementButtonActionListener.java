...
public class DesktopIncrementButtonActionListener implements ActionListener {
	private final Desktop	desktop;
	private final Model		model;

	public DesktopIncrementButtonActionListener(final Model model, final Desktop desktop) {
