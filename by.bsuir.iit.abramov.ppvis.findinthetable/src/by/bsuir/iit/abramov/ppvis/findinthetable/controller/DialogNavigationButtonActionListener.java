...
public class DialogNavigationButtonActionListener implements ActionListener {
	...
	public DialogNavigationButtonActionListener(final Model model, final FindDialog findDialog) {
		this.model = model;
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if (Window.geti18nString(Desktop.BUTTON_PREV).equalsIgnoreCase(button.getText())) {
